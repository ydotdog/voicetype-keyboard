...
PRODUCTS = [
    CreditProduct(
        ...
        reference_name="990,000 Credits",
        display_name="990,000 Credits",
        description="Non-expiring pay-as-you-go VoiceType credits.",
        target_customer_price=Decimal("0.99"),
    ),
    CreditProduct(
        key="medium",
        product_id="com.kyleqi.voicetype.credits.medium",
        reference_name="4,990,000 Credits",
    ...
    CreditProduct(
        ...
        reference_name="19,990,000 Credits",
